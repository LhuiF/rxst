...
var t=$(_98).empty();
    if (_99.text == "新增") {
        t.addClass("btn-add");
        // _9a=$("<span class=\"btn-save\"></span>").appendTo(t);
    }
    if (_99.text == "添加图片") {
        t.addClass("btn-add");
        // _9a=$("<span class=\"btn-save\"></span>").appendTo(t);
    ...
    if (_99.text == "删除") {
        t.addClass("btn-remove");
        // _9a=$("<span class=\"btn-save\"></span>").appendTo(t);
    }
    if (_99.text == "查询") {
        t.addClass("btn-search");
        // _9a=$("<span class=\"btn-save\"></span>").appendTo(t);
    }
	if(_99.text=="保存"){
		t.addClass("btn-save");
		// _9a=$("<span class=\"btn-search\"></span>").appendTo(t);
	}
    if (_99.text == "启用") {
        t.addClass("btn-save");
        // _9a=$("<span class=\"btn-search\"></span>").appendTo(t);
